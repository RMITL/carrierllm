...
const plans = [
    {
        name: 'Free User',
        clerkPlanKey: 'free_user',
        price: 0,
        recommendations: 5,
        features: [
            'Up to 5 recommendations per month',
    ...
    {
        name: 'Individual',
        clerkPlanKey: 'individual',
        price: 50,
        recommendations: 100,
        popular: true,
        features: [
            'Up to 100 recommendations per month',
...
export const BillingPage = () => {
    ...
    // Check current Clerk subscription status
    const hasIndividualPlan = user?.has?.({ permission: 'individual' }) || false;
    const hasEnterprisePlan = organization?.has?.({ permission: 'enterprise' }) || false;
    const isFreePlan = !hasIndividualPlan && !hasEnterprisePlan;
