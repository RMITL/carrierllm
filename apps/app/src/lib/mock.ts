import type { CarrierRecommendation, CarrierCitation, RecommendationResponse, OrionRecommendationResponse } from '../types';

const mockCitations: CarrierCitation[] = [
  {
    chunkId: 'chunk-1',
...
const orionCarriers: CarrierRecommendation[] = [
  {
    carrierId: 'acme-life',
...
const legacyCarriers: CarrierRecommendation[] = [
  {
    carrierId: 'acme-life',
    carrierName: 'Acme Life',
...
export const buildMockOrionRecommendation = (): OrionRecommendationResponse => ({
